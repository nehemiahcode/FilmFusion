            ...
            <div className="max-w-screen-xl mx-auto px-4 dark:text-white md:px-8">
                <div className="space-y-6 sm:max-w-md sm:mx-auto sm:text-center">
                    ...
                    <div className="items-center gap-x-3 space-y-3 sm:flex sm:justify-center sm:space-y-0">
                        ...
                        <Link href="" className="flex items-center justify-center gap-x-2 py-2 px-4 dark:text-white hover:text-gray-500 font-medium duration-150 active:bg-gray-100 border rounded-lg md:inline-flex">
                          Find a Tv
