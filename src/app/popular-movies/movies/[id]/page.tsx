    ...
    return (
        ...
        >
            ...
            <div className="relative max-w-full grid grid-cols-1 md:grid-cols-1 xl:grid-cols-3  place-content-center place-items-center md:place-items-start">
                <div className="rounded-md col-span-1 h-[31rem] shadow-2xl w-full sm:max-w-lg md:max-w-xl">
                    <Image
                        src={`https://image.tmdb.org/t/p/w500/${data.poster_path}`}
                        alt={`Image of ${data.title}`}
                        height={600}
                        width={600}
                        className="h-[31rem] w-full rounded-md object-cover"
                    />
                </div>

                <div className="md:px-5 md:col-span-2 col-span-1 max-w-full mt-5 md:mt-0 text-white">
                    ...
                    <div className="flex flex-1 items-center gap-4 max-w-lg md:max-w-xl overflow-x-auto ">
